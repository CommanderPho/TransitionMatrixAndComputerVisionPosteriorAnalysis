...
%
% Auto-generated by imageBatchProcessor app on 2024-08-27
%----------------------------------------------------------

narginchk(0, 2);

if nargin == 0
    source = "C:\Users\pho\repos\Spike3DWorkEnv\Spike3D\output\_temp_individual_posteriors\2024-08-27\laps\greyscale";
    outDir = "";
elseif nargin == 1
...
workSpaceFields = {
    'E','blurredImg','bw','imgray','l','m00','m01','m02','m10','m11','m20','seg_bw','seg_maskedImage','theta','w','x','x1','x2','y','y1','y2','fileName'
    };
