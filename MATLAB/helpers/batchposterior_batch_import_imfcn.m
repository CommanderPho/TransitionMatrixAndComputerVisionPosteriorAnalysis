...
%    seg_bw saved as tiff format
%    seg_maskedImage saved as tiff format
%
...
%
% Auto-generated by imageBatchProcessor app on 2024-08-22
%----------------------------------------------------------

narginchk(0, 2);

if nargin == 0
    source = "C:\Users\pho\repos\Spike3DWorkEnv\Spike3D\output\_temp_individual_posteriors\2024-08-21\laps\greyscale";
    outDir = "";
elseif nargin == 1
...
workSpaceFields = {
    'E','blurredImg','bw','imgray','l','m00','m01','m02','m10','m11','m20','theta','w','x','x1','x2','y','y1','y2','fileName'
    };
...
parfor partCnt = 1:numParts
    ...
    partResults{partCnt} = applyBatchFcn(imds, inDir, outDir, workSpaceFields, fileFieldsAndFormat);
end
...
function result = applyBatchFcn(imds, inDir, outDir, workSpaceFields, fileFieldsAndFormat)
